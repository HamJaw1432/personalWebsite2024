  ...
  return (
    <div className={styles.mainText}>
      ...
      <div className={styles.textSection}>
        ...
        high distiction with a 3.67 GPA (out of 4), and I was on the Dean's list
        in 2019-2020, 2020-2021, 2021-2022, 2022-2023, and 2023-2024.
      </div>
      <div className={styles.textSection}>
        My prusuit in life right now is to become the embodyment of the saying
        'A jack of all trades is a master of none, but oftentimes is better than
        a master of one.', by this I mean to ---hopfully--- in the coming years
        work on imporving my software development skills to the point that I can
        work on any part of any project. I want to be the guy that be relied on
        to get stuff done, on the frontend, backend, or anywhere else.
      </div>
      <div className={styles.textSection}>
      ...
      <div className={styles.textSection}>
        ...
        <ul>
          ...
          <li>
            ...
            effects I have on others as a person are one of the most important
            part of lifing a good happy and successfull life.
          </li>
          <li>
            Learning about differnt things like Theology, Physics, History, and
            more. I generally like to know stuff, even though ignorance is a
            bliss, I like to learn about the world I live in.
          </li>
          <li>Working out. Lift heavy, be happy (*caveman noises*).</li>
          <li>I also enjoy food. It keeps me alive.</li>
        </ul>
